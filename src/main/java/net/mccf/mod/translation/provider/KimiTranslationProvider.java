 ...
 * {@link OpenAiTranslationProvider} 的请求构造 / 响应解析逻辑。
 *
...
public class KimiTranslationProvider implements TranslationProvider {
	...
	public CompletableFuture<TranslationResult> translate(TranslationRequest request) {
		...
		String endpoint = OpenAiTranslationProvider.stripTrailingSlash(config.effectiveEndpoint(ID)) + "/v1/chat/completions";
